...
if __name__ == "__main__":
    ...
    EXCLDUE_NIGHT_VALUES = [True, False]
    CLASSES = [True, False]
    labels = ["pkg_dk", "pkg_bk", "pkg_tremor"]

    EXCLUDE_NIGHT_TIME = EXCLDUE_NIGHT_VALUES[run_idx // (len(CLASSES) * len(labels))]
    ...
    for loc_ in ["ecog_stn", ]:  # "ecog", "stn"
        ...
        SAVE_NAME = f"LOHO_exludenight_{EXCLUDE_NIGHT_TIME}_CLASS_{CLASS}_label_{label_name}.pkl"
