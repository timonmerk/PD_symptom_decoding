...
if __name__ == "__main__":
    ...
    EXCLUDE_hour_features = [True, False]
    CLASSES = [True, False]
    labels = ["pkg_dk", "pkg_bk", "pkg_tremor"]

    EXCLUDE_hour_feature = EXCLUDE_hour_features[run_idx // (len(CLASSES) * len(labels))]
    ...
    for loc_ in ["ecog_stn", ]:  # "ecog", "stn"
        ...
        SAVE_NAME = f"LOHO_exludehour_nonorm_{EXCLUDE_hour_feature}_CLASS_{CLASS}_label_{label_name}_withpsd.pkl"
