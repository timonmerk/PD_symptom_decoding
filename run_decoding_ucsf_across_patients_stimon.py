...
if __name__ == "__main__":
    ...
    # remove the subjects that have less than 15 samples
    subs = [s for s in subs if df_all[df_all["sub"] == s].shape[0] > 15]
...
#                         model = linear_model.LogisticRegression(class_weight="balanced")
    ...
    SAVE_NAME = "LOHO_ALL_LABELS_ALL_GROUPS_STIM_OFF_ONLY.pkl"
