...
if __name__ == "__main__":
    ...
    # I need 14 * 3 jobs 0-41 (including 41)
    PATH_READ = "/Users/Timon/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/Shared Documents - ICN Data World/General/Data/UCSF_OLARU/features/merged_normalized"
    ...
    PATH_READ = "/data/cephfs-1/home/users/merkt_c/work/PD_symptom_decoding/features"
    PATH_PER = "/data/cephfs-1/home/users/merkt_c/work/PD_symptom_decoding/out_per"
    PLT_PDF = False

    run_idx = int(sys.argv[1])
    WITH_HOUR = bool(int(sys.argv[2]))
    ...
    norm_windows = [0, 5, 10, 20, 30, 60, 120, 180, 300, 480, 720, 960, 1200, 1440]
    label_name = label_names[run_idx // len(norm_windows)]
    norm_window = norm_windows[run_idx % len(norm_windows)]
    ...
    # else:
    df_all = pd.read_csv(os.path.join(PATH_READ, str(norm_window), "all_merged_normed_with_condition.csv"), index_col=0)
    ...
    SAVE_NAME = f"d_out_patient_across_{label_name}_class_{CLASSIFICATION}_{str(norm_window)}_{WITH_HOUR}.pkl"
